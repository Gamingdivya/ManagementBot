...
import MahakRobot.modules.sql.blacklist_sql as sql
from MahakRobot import LOGGER, dispatcher
...
from MahakRobot.modules.helper_funcs.chat_status import user_admin, user_not_admin
from MahakRobot.modules.helper_funcs.extraction import extract_text
from MahakRobot.modules.helper_funcs.misc import split_message
...
from MahakRobot.modules.warns import warn
...
def add_blacklist(update, context):
    ...
    if len(words) > 1:
        ...
        if len(to_blacklist) == 1:
            ...
            send_message(
                update.effective_message,
                "❍ ᴀᴅᴅᴇᴅ ʙʟᴀᴄᴋʟɪsᴛ ᴛʀɪɢɢᴇʀ <code>{}</code> ɪɴ <b>{}</b>!".format(
...
__help__ = """
❍ ʙʟᴀᴄᴋʟɪsᴛs ᴀʀᴇ ᴜsᴇᴅ ᴛᴏ sᴛᴏᴘ ᴄᴇʀᴛᴀɪɴ ᴛʀɪɢɢᴇʀs ғʀᴏᴍ ʙᴇɪɴɢ sᴀɪᴅ ɪɴ ᴀ ɢʀᴏᴜᴘ. Aɴʏ ᴛɪᴍᴇ ᴛʜᴇ ᴛʀɪɢɢᴇʀ ɪs ᴍᴇɴᴛɪᴏɴᴇᴅ, ᴛʜᴇ ᴍᴇssᴀɢᴇ ᴡɪʟʟ ɪᴍᴍᴇᴅɪᴀᴛᴇʟʏ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ. A ɢᴏᴏᴅ ᴄᴏᴍʙᴏ ɪs sᴏᴍᴇᴛɪᴍᴇs ᴛᴏ ᴘᴀɪʀ ᴛʜɪs ᴜᴘ ᴡɪᴛʜ ᴡᴀʀɴ ғɪʟᴛᴇʀs!
