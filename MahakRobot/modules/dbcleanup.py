...
import MahakRobot.modules.sql.global_bans_sql as gban_sql
import MahakRobot.modules.sql.users_sql as user_sql
from MahakRobot import DEV_USERS, OWNER_ID, dispatcher
