...
def site_search(update: Update, context: CallbackContext, site: str):
    ...
    if site == "kaizoku":
        ...
        if search_result:
            result = f"❍ <b>sᴇᴀʀᴄʜ ʀᴇsᴜʟᴛs ғᴏʀ</b> <code>{html.escape(search_query)}</code> <b>ᴏɴ</b> @God_Ravana \n"
            ...
            more_results = False
            result = f"❍ <b>ɴᴏ ʀᴇsᴜʟᴛ ғᴏᴜɴᴅ ғᴏʀ</b> <code>{html.escape(search_query)}</code> <b>ᴏɴ</b> @God_Ravana"
